...
namespace CDL2v1 {
   ...
   public class Note : SerializationBase, IEquatable<Note?>  {
      ...
      public static readonly Note DuplicateLabel                    = new(NoteType.Error  , 006, "{0}: duplicate label in group hierarchy");
      ...
      public static readonly Note InvalidListBounds                 = new(NoteType.Error  , 011, "LIST {0} has invalid bounds. Only CONSTs are allowed");
      public static readonly Note UnexpectedToken                   = new(NoteType.Error  , 012, $"Expected token {{0}}. Found {{1}}. Skipping to next '{Token.TokenType2Glyph[TT.END]}'");
      ...
      public static readonly Note InvalidToken                      = new(NoteType.Error  , 028, "Invalid token during lexical analysis. Skipping {0}");
      ...
      public static readonly Note EmptyLude                         = new(NoteType.Error  , 039, "{0} is empty.");
