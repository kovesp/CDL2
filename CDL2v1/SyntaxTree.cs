...
namespace CDL2v1 {
   ...
   /// <param Id="Id"></param>
   [Serializable]
   public abstract class NamedElement(ID id,bool synthetic = false) {
      public ID Id { get; } = id;
      /// <summary>
   ...
   public class Module : Container {
      public readonly Dictionary<ID,IImportable> imports = [];        // Imports are specified in sections, but are propagated up the module level.
      public readonly Dictionary<ID,IProvidable> exports = [];        // Exports are specified in sections, but are propagated up the module level.
      /// <summary>
   ...
   public class Section : Container {
      ...
      /// </summary>
      public readonly Dictionary<ID,CDL2Object> Declarations = [];
   ...
   public class Procedure(ID id,List<Affix> formals,Set<Local> locals,Token algorithmType,TT bodyType,Section section,bool synthetic = false) 
      ...
      public class InliningParameters {
         public int MaxInlineCalls = Settings.SettingValue<int>("MaxInlineCalls");
         public int NumberOfTimesCalled = 0;
         public int NumberOfCallsInProc = 0;

         private readonly Procedure proc;

         public InliningParameters(Procedure proc, Reachable reachable) {
            this.proc = proc;
   ...
   /// <param Id="type"></param>
   [Serializable]
   public class Affix(ID id,AffixDir dir,AffixType type) : NamedElement(id), IFailureProtected, IMacroElement, ITrackedVar  {
