...
namespace CDL2v1 {
   ...
   /// <param id="bodyType"></param>
   /// <param id="section"></param>
   internal class Procedure(ID id,List<Affix> formals,Set<Local> locals,Token algType,TT bodyType,Section section,bool synthetic=false) 
      : Algorithm(id,formals,locals,algType,bodyType,section,synthetic) {
