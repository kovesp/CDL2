...
namespace CDL2v1 {
   ...
   internal interface IScope {
      /// <summary>
      /// The parent scope of this one. Null for the top level scopes of Modules and Programs.
      /// (Affix, Local, Group => Algorithm),  Const, Var, List, Imported Const, Imported Algorithm => Section => Layer => Module => Program
      /// </summary>
      //public IScope? ParentScope { get; }
      //public Dictionary<ID,NamedElement> ScopeObjects { get; }
   }
   ...
   /// <param id="affixes">The argument list.</param>
   /// <param id="locals">The locals.</param>
   /// <param id="algorithmType">The algorithm type.</param>
   /// <param id="bodyType">The type of body.</param>
   /// <param id="container">The containing container.</param>
   internal abstract class Algorithm : NamedElement, IProvidedElement, ICDL2Object, IScope {
      ...
      public readonly Set<Local> locals;           // The local variables of this alorithm.
      ...
      public SA NameAnnotation {
         get {
            SA getSA() {
               ...
               if (section.inv.Contains(id)) { // More complicated then local. Need to find the container the algorithm is abstracted or extended from
