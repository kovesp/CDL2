      ...
      private void GenerateActualArg(Procedure proc, Call call, Affix calledAffix, IActualArg arg) {
         switch (arg) {
            ...
            case Const c:
               ...
               break;
            case Var v:
               cg.GenerateCallArgReferenceVar(calledAffix, v, needFinalization: call.CanFail);
               break;
            case ID id: // May be a reference to an affix or local of the calling proc or a const, or a var.
               ...
               break;
            case Affix a:  cg.GenerateCallArgReferenceAffix(calledAffix, a, needFinalization: call.CanFail); break;
