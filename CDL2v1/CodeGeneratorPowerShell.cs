...
function Set-Constant([string]$name,[<%3%>]$value) {
...
";
      ...
      /// </summary>
      /// <param name="c"></param>
      void ICodeGenerator.GenerateConstantStart(Const c) => emitter.Emit(PSVar(c), " = 0; Set-Constant '",PSVarPrefix(PSVarType.Const),PSName(c),"' ");
#endif
